...
var __meta__ = {
    ...
    name: "Menu",
    category: "web",
    description: "The Actionmenu widget displays hierarchical data as a multi-level menu inside a grid cell",
    depends: [ "popup" ]
};
    ...
    var Menu = Widget.extend({
        ...
        _itemLeft: function (item, belongsToVertical) {
            ...
            if (!belongsToVertical) {
                ...
                that.close(nextItem);
                if (that._isRootItem(nextItem) &&a that.options.orientation == "horizontal") {
